...
df_trim = df_trim.query("plies > 10")
...
plot_rolling_rates_with_ci(df_games, window=1000)
tail_vs_prev(df_games, window=1000)
...
gv = GameViewer(view[-7]['json_file']); gv.replay()
#%%